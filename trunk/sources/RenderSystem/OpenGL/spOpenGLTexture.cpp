...
const GLenum GLTexInternalFormatListFloat16[] = {
    GL_R16F, GL_LUMINANCE16F_ARB, GL_RG16F, GL_RGB16F_ARB, GL_RGB16F_ARB, GL_RGBA16F_ARB, GL_RGBA16F_ARB, GL_DEPTH_COMPONENT24
};

const GLenum GLTexInternalFormatListFloat32[] = {
    GL_R32F, GL_LUMINANCE32F_ARB, GL_RG32F, GL_RGB32F_ARB, GL_RGB32F_ARB, GL_RGBA32F_ARB, GL_RGBA32F_ARB, GL_DEPTH_COMPONENT32F
};
