...
enum EDeferredRenderFlags
{
    ...
    */
    DEFERREDFLAG_USE_TEXTURE_MATRIX         = 0x00000001,
    /**
    ...
    */
    DEFERREDFLAG_HAS_SPECULAR_MAP           = 0x00000002,
    /**
    ...
    */
    DEFERREDFLAG_HAS_LIGHT_MAP              = 0x00000004,
    //! Allows the lighting to over-blend. By default disabled.
    DEFERREDFLAG_ALLOW_OVERBLENDING         = 0x00000008,
    ...
    */
    DEFERREDFLAG_NORMAL_MAPPING             = 0x00000010,
    /**
    ...
    */
    DEFERREDFLAG_PARALLAX_MAPPING           = 0x00000020,
    /**
    ...
    */
    DEFERREDFLAG_GLOBAL_ILLUMINATION        = 0x00000100,
    /**
    ...
    */
    DEFERREDFLAG_DEBUG_GBUFFER              = 0x01000000,
    /**
    ...
    */
    DEFERREDFLAG_DEBUG_GBUFFER_WORLDPOS     = 0x02000000,
    /**
    This option can be used for debugging purposes. It renders the
    texture coordinates as colors for each pixel instead of the diffuse colors.
    This requires gbuffer debugging (DEFERREDFLAG_DEBUG_GBUFFER).
    */
    DEFERREDFLAG_DEBUG_GBUFFER_TEXCOORDS    = 0x04000000,
    /**
    ...
    This requires global illumination (DEFERREDFLAG_GLOBAL_ILLUMINATION).
    */
    DEFERREDFLAG_DEBUG_VIRTUALPOINTLIGHTS   = 0x08000000,
};
